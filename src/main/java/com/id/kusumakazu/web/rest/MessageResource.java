...
/**
 * REST controller for managing {@link com.id.kusumakazu.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
    ...
    private static final String ENTITY_NAME = "microchatsvcMessage";
    ...
    public ResponseEntity<MessageDTO> partialUpdateMessage(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, messageDTO.getId())
        );
    }
